...
public class ButtonIconBuilder {
    ...
    public ButtonIconViewImpl build() {
        ...
        iconBootstrapView.root.setClassName(BASE_STYLE + HasStyle.appendString(colorType) + HasStyle.appendString(outlineColorType)
                                            + HasStyle.appendString(size));
        iconBootstrapView.iconPanel.setClassName(HasStyle.appendString(iconType) + HasStyle.appendString(iconSize));
