...
//            list.getRowCellConfig().setFieldGetter(o -> o + "");
        ...
        public static void getChildren(HasRowsDataList<ItemId> hasRowsData, HTMLElement htmlElement, ComponentHtmlParser cp) {
            NodeList<? extends HTMLElement> elementsByTagName = htmlElement.getElementsByTagName(ITEM);
            for (int i = 0; i < elementsByTagName.getLength(); i++) {
                final HTMLElement at = (HTMLElement) elementsByTagName.item(i);
