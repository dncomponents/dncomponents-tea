...
//        view.getRowCellConfig().setFieldGetter(node -> node.getUserObject() + "");
        ...
        setItemRenderer((node, slots) -> slots.getMainSlot().setTextContent(node.getUserObject() + ""));
    ...
    public static class AutocompleteTreeMultiSelectHtmlParser extends AbstractPluginHelper implements ComponentHtmlParser {
        ...
        public BaseComponent parse(HTMLElement htmlElement, Map<String, ?> elements) {
            ...
            if (htmlElement.hasChildNodes()) {
                ...
                autocomplete.getRowCellConfig().setCellRenderer(r -> r.valuePanel.setInnerHTML(
