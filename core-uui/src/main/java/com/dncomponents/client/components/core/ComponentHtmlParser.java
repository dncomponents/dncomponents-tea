...
public interface ComponentHtmlParser extends IsElementHtmlParser<BaseComponent> {
    ...
    default ItemId getIdItem(HTMLElement element) {
        ItemId idItem = new ItemId();
        idItem.setId(getElementId(element));
        idItem.setContent(element.getInnerHTML());
    ...
    default String getElementId(HTMLElement element) {
    ...
    default <T extends View> T getView(Class viewClazz, HTMLElement html, Map<String, ?> elements) {
