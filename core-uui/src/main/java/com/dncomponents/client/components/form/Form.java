...
public class Form<T> extends BaseComponent<T, FormUi> implements HasModelChangedHandlers<T> {
    ...
    public static class FormHtmlParser extends AbstractPluginHelper implements ComponentHtmlParser {
        ...
        private static FormHtmlParser instance;
        ...
        public static FormHtmlParser getInstance() {
            if (instance == null)
                return instance = new FormHtmlParser();
            return instance;
        }
        ...
        public BaseComponent parse(HTMLElement htmlElement, Map<String, ?> elements) {
            ...
            for (int i = 0; i < elementsByTagName.getLength(); i++) {
                FormItem formItem = parseItem((HTMLElement) elementsByTagName.item(i), form);
        ...
        public FormItem parseItem(HTMLElement element, Form form) {
            ...
            if (element.getFirstChild() != null) {
                ...
                if (firstChild instanceof HTMLElement) {
                    firstElementChild = (HTMLElement) firstChild;
                } else {
