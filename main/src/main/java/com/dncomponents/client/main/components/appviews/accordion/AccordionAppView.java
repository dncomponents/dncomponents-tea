...
public class AccordionAppView implements IsElement {
    ...
    private void initEvents() {
        eventsAccordion.setItemRenderer((people, slots) -> {
            slots.getTitle().setInnerHTML(people.getName() + "");
            slots.getContent().setInnerHTML(people.getAge() + "");
        });
    ...
    private void initRenderer() {
        accordionRenderer.setItemRenderer((userObject, slots) -> {
            slots.getTitle().setInnerHTML("<h4>" + userObject.getName() + "</h4>");
            slots.getContent().setInnerHTML(userObject.getDescription());
        });
        ...
        accordionItem.setRenderer((fruit, slots) -> {
            slots.getTitle().setInnerHTML("<b>" + fruit.getName() + "</b>");
            slots.getTitle().getStyle().setProperty("color", "red");
