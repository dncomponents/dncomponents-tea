...
public class AutocompleteListAppView implements IsElement {
    ...
    private void initRenderer() {
        ...
        acMsRenderer.getRowCellConfig().setCellRenderer(r -> r.valuePanel.setInnerHTML("<b>" + r.value + "</b>"));
        acMsRenderer.setRowsData(fruits);
        acRenderer.getRowCellConfig().setCellRenderer(r -> r.valuePanel.setInnerHTML("<b>" + r.value + "</b>"));
