...
public class AutocompleteTreeAppView implements IsElement {
    ...
    private void initRenderer() {
        acMsTreeRenderer.getRowCellConfig().setCellRenderer(r -> r.valuePanel.setInnerHTML("<b>" + r.value + "</b>"));
        acMsTreeRenderer.setRoot(Fruit.getFruitsTree());
        acTreeRenderer.getRowCellConfig().setCellRenderer(r -> r.valuePanel.setInnerHTML("<b>" + r.value + "</b>"));
