...
public class ModalAppView implements IsElement {
    ...
    private void initEvents() {
        eventsDialog.setHeader(e -> e.setTextContent("Header"));
        eventsDialog.setFooter(e -> e.setTextContent("Footer"));
        eventsDialog.setContent(e -> e.setTextContent("Content"));
    ...
    private void initRenderer() {
        rendererDialog.setRenderer((userObject, slots) -> {
            slots.getHeaderPanel().setInnerHTML("<b>" + userObject.getName() + "</b>");
            slots.getContentPanel().setInnerHTML("<b>" + userObject.getDescription() + "</b>");
        });
