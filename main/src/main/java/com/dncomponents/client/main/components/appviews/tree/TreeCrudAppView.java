...
public class TreeCrudAppView implements IsElement {
    ...
    private void testDifferentEntities() {
        ...
        fruitCellConfig.setCellRenderer(r -> {
            ...
            r.valuePanel.getStyle().setProperty("color", "blue");
        });
        tree.getRowCellConfig().setCellRenderer(r -> r.valuePanel.setInnerHTML(r.value + ""));
        ...
        personCellConfig.setCellRenderer(r -> r.valuePanel.setInnerHTML("" + r.value + " Person"));
